...
export function buildMockEnrouteWeather(flightLevel: number): EnrouteWeather {
  const below = Math.max(180, flightLevel - 40);
  const above = Math.min(450, flightLevel + 40);
  return {
    windsAloft: [
      {
    ...
    turbulence: [
      {
        ...
        flightLevel: below,
        altitudeBand: "below",
        flightLevelBand: `FL${below} (−4000 ft)`,
        expectedDuration: "About 20–45 minutes",
        likelyCause: "UNKNOWN",
        confidence: "LOW",
        pilotText: `KJFK–50N050W @ FL${below}\nSmooth.`,
        notes: "Cause indeterminate from available model fields. Confidence LOW.",
      },
      {
        segmentLabel: "KJFK–50N050W",
        fromFix: "KJFK",
        ...
        flightLevel,
        altitudeBand: "cruise",
        flightLevelBand: `FL${flightLevel} (cruise)`,
        expectedDuration: "About 20–45 minutes",
        likelyCause: "CLEAR_AIR",
        confidence: "MEDIUM",
        pilotText: `KJFK–50N050W @ FL${flightLevel}\nOccasional light turbulence.`,
      ...
      },
      {
        ...
        flightLevel: above,
        altitudeBand: "above",
        flightLevelBand: `FL${above} (+4000 ft)`,
        expectedDuration: "About 20–45 minutes",
        likelyCause: "CLEAR_AIR",
        confidence: "MEDIUM",
        pilotText: `KJFK–50N050W @ FL${above}\nOccasional light turbulence.`,
        notes: "Clear-air turbulence risk from vertical shear. Confidence MEDIUM.",
      },
      {
        ...
        confidence: "MEDIUM",
        pilotText: `50N050W–EGLL @ FL${below}\nOccasional light turbulence.`,
        notes: "Likely jet-stream related wind shear. Confidence MEDIUM.",
      },
      {
        segmentLabel: "50N050W–EGLL",
        fromFix: "50N050W",
        ...
        likelyCause: "JET_STREAM_SHEAR",
        confidence: "HIGH",
        pilotText: `50N050W–EGLL @ FL${flightLevel}\nModerate CAT possible. FL${flightLevel}.`,
      ...
      },
      {
        ...
        likelyCause: "JET_STREAM_SHEAR",
        confidence: "HIGH",
        pilotText: `50N050W–EGLL @ FL${above}\nModerate CAT possible. FL${above}.`,
        notes: "Likely jet-stream related wind shear. Confidence HIGH.",
      },
    ],
    convective: [
    ...
    alongRouteNotes: [
      ...
      `Turbulence assessed at FL${below} / FL${flightLevel} / FL${above} (±4000 ft).`,
    ],
    sigmets: MOCK_SIGMETS,
    waypointConditions: [],
    dispatchBullets: [
      "Moderate turbulence expected after oceanic entry.",
      `Smoother ride likely FL${below} (−4000 ft) on 50N050W–EGLL.`,
